...
This file intentionally does not launch Isaac Lab. It documents the desired
...
def build_training_plan(seed: int = 0) -> list[dict]:
    ...
    return [build_ppo_config(curriculum.get_config(p), seed=seed) for p in progress_points]
